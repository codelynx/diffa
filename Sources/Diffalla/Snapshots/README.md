...
DIFFALLA_RUN_BENCHMARKS=1 swift test --filter testVeryLargeDirectory
```
...
} catch DiffallaError.permissionDenied(let path) {
    print("Permission denied: \(path)")
} catch DiffallaError.snapshotCreationFailed(let reason) {
